-- ================================================================
-- 04_xxljob_schema.sql
-- XXL-JOB 2.4.0 数据库表结构
-- ================================================================
USE xxl_job;
...
-- 初始化数据（admin/123456）
INSERT IGNORE INTO `xxl_job_group`(`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL, '2026-01-01 00:00:00');
-- order-service 执行器
INSERT IGNORE INTO `xxl_job_group`(`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (2, 'order-service', '订单服务执行器', 0, NULL, '2026-01-01 00:00:00');
...
SELECT 'XXL-JOB schema initialized!' AS status;
