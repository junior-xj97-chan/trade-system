...
public class SearchController {
    ...
    public R<SearchResponse> search(@RequestBody SearchRequest request) {
        log.info("搜索请求: keyword={}, market={}, exchangeCode={}, minPrice={}, maxPrice={}, sortField={}, sortOrder={}, page={}, size={}",
                ...
                request.getSortFieldEffective(), request.getSortFieldEffective(),
    ...
    @GetMapping("/quick")
    public R<SearchResponse> quickSearch(
    ...
    public R<ProductDocument> findByCode(
    ...
    @PostMapping("/index")
    public R<ProductDocument> indexProduct(@RequestBody ProductDocument product) {
    ...
    public R<Void> indexProducts(@RequestBody List<ProductDocument> products) {
    ...
    public R<String> fullSync() {
        ...
        return R.ok("全量同步任务已触发，请查看控制台日志");
    }
    ...
    public R<String> incrementalSync() {
        log.info("手动触发增量同步");
        dataSyncService.incrementalSync();
        return R.ok("增量同步任务已触发，请查看控制台日志");
    }
}
