...
chcp 65001 >nul
echo ========================================
echo Search Service 启动 (带 SkyWalking Agent)
echo ========================================

set SERVICE_NAME=search-service
set SERVICE_PORT=9006
...
cd /d %~dp0..\search-service
java %JAVA_OPTS% -jar target\search-service-1.0.0.jar %SERVER_OPTS%
